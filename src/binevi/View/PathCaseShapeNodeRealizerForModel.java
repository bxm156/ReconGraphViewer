...
public class PathCaseShapeNodeRealizerForModel extends ShapeNodeRealizer {
    ...
    public PathCaseShapeNodeRealizerForModel() {
        super();
    ...
    public static enum PathCaseNodeRole {
        ...
        MODEL,COMPARTMENT,SPECIES,REACTION,REACTIONSPECIES
    }
